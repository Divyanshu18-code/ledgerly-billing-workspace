...
// Exactly 2 billing software related suggestions as requested
...
export const CreateQuotationPage: React.FC = () => {
  ...
  // Use DB products if available, or fall back to exactly 2 billing software suggestions
  ...
  // Client Combobox Dropdown Toggle State
  const [isClientOpen, setIsClientOpen] = useState(false);
  const clientRef = useRef<HTMLDivElement>(null);

  // Product Combobox Dropdown Toggle State
  ...
  // Filter clients based on direct input
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!finalClientId) {
      setErrorMsg('Please select or enter a valid client for this proposal');
      return;
    }
  ...
  return (
    <div className="relative space-y-8 max-w-6xl mx-auto pb-20">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
              Draft estimations, configure product line rates, and issue formal rate proposals to clients
            </p>
          </div>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-8 relative z-10">
        {/* Card 1: Proposal Details & Recipient */}
            ...
            <table className="w-full text-left text-xs border-collapse">
              ...
              <tbody className="divide-y divide-gray-100 dark:divide-white/5">
                {items.map((item, index) => {
                  ...
                  // Filter suggestions live based on description input
                  ...
                  return (
                    <tr key={index} className="hover:bg-gray-50/50 dark:hover:bg-white/[0.02] transition-colors">
                      {/* Direct Editable + Dropdown Item Combobox */}
                      <td className="py-3 px-3 relative" ref={activeProductRow === index ? productRef : null}>
                        ...
                        {/* Floating Item Suggestions Dropdown */}
        ...
        {/* Card 3 & 4: Notes & Live Grand Total Summary */}
          ...
          <div className="md:col-span-2 p-6 sm:p-7 rounded-[26px] border border-gray-200/80 dark:border-white/10 bg-white/80 dark:bg-[#13111c]/80 backdrop-blur-2xl shadow-sm space-y-5">
            ...
            <div className="space-y-2">
              ...
              <textarea
                ...
                placeholder="Scope of work details or proposal note..."
